...
const fdk = new PinataFDK({
    pinata_jwt: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..kiAKLaZltjstI2PES9n4zKv5lqtxnJ7MM-Bi5wj7VtY",
...
export default async function Home({ params, searchParams }: HomeProps) {
    ...
    donations = Object.entries(donations).sort((x: any, y: any) => y[1] - x[1]).slice(0, 3)
    ...
    return (
        <FrameContainer
            ...
            <FrameImage aspectRatio="1.91:1">
                ...
                {donations[0] && <div tw="flex">1. {donations[0].name}: ${donations[0].value}</div>}
                {donations[1] && <div tw="flex">2. {donations[1].name}: ${donations[1].value}</div>}
                {donations[2] && <div tw="flex">3. {donations[2].name}: ${donations[2].value}</div>}
            </FrameImage>
            <FrameButton
